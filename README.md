# Client for the Bot Server API @ https://github.com/Szetty/bot-server.git


## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `Bot Server API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the Bot Server API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | BotServer                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | bot-server                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | BotServerConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | BotServerRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| BotServer.Client    | use the "dispatch" functions to send requests       |
| BotServer.Core      | core funcions, config and request types             |
| BotServer.API       | construct api requests                              |
| BotServer.Model     | describes api models                                |
| BotServer.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| BotServer.ModelLens | lenses for model fields                             |
| BotServer.Logging   | logging functions and utils                         |
...
You can find an example implementation of a bot in bots/ExampleBot.hs