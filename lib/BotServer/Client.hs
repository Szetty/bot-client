...
dispatchLbs
  ...
  -> BotServerRequest req contentType res accept -- ^ request
...
_toInitRequest config req0  = 
  runConfigLogWithExceptions "Client" config $ do
    ...
    let req2 = req1 & _setContentTypeHeader & _setAcceptHeader
        ...
        pReq = parsedReq { NH.method = rMethod req2, NH.requestHeaders = reqHeaders, NH.queryString = reqQuery }
