...
-- | 
data BotServerConfig = BotServerConfig
...
-- | display the config
instance P.Show BotServerConfig where
  show c =
    T.printf
...
-- | constructs a default BotServerConfig
--
-- configHost:
--
-- @http://localhost@
...
-- @"bot-server/0.1.0.0"@
--
newConfig :: L.Text -> IO BotServerConfig
newConfig configHost = do
    logCxt <- initLogContext
    return $ BotServerConfig
        { configHost = encodeUtf8 configHost
        , configUserAgent = "bot-server/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => BotServerConfig -> auth -> BotServerConfig
addAuthMethod config@BotServerConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: BotServerConfig -> IO BotServerConfig
...
withStderrLogging :: BotServerConfig -> IO BotServerConfig
...
withNoLogging :: BotServerConfig -> BotServerConfig
...
data BotServerRequest req contentType res accept = BotServerRequest
  { rMethod  :: NH.Method   -- ^ Method of BotServerRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of BotServerRequest
  , rParams   :: Params -- ^ params of BotServerRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (BotServerRequest req contentType res accept) NH.Method
rMethodL f BotServerRequest{..} = (\rMethod -> BotServerRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (BotServerRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f BotServerRequest{..} = (\rUrlPath -> BotServerRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (BotServerRequest req contentType res accept) Params
rParamsL f BotServerRequest{..} = (\rParams -> BotServerRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (BotServerRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f BotServerRequest{..} = (\rAuthTypes -> BotServerRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => BotServerRequest req contentType res accept -> param -> BotServerRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: BotServerRequest req contentType res accept -> param -> BotServerRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: BotServerRequest req contentType res accept -> param -> BotServerRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** BotServerRequest Utils

_mkRequest :: NH.Method -- ^ Method 
          -> [BCL.ByteString] -- ^ Endpoint
          -> BotServerRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = BotServerRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader :: BotServerRequest req contentType res accept -> [NH.Header] -> BotServerRequest req contentType res accept
setHeader req header =
  req `removeHeader` P.fmap P.fst header &
  L.over (rParamsL . paramsHeadersL) (header P.++)

removeHeader :: BotServerRequest req contentType res accept -> [NH.HeaderName] -> BotServerRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => BotServerRequest req contentType res accept -> BotServerRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of 
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => BotServerRequest req contentType res accept -> BotServerRequest req contentType res accept
_setAcceptHeader req =
    case mimeType (P.Proxy :: P.Proxy accept) of 
        Just m -> req `setHeader` [("accept", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["accept"]

setQuery :: BotServerRequest req contentType res accept -> [NH.QueryItem] -> BotServerRequest req contentType res accept
setQuery req query = 
  req &
  L.over
...
addForm :: BotServerRequest req contentType res accept -> WH.Form -> BotServerRequest req contentType res accept
addForm req newform = 
...
_addMultiFormPart :: BotServerRequest req contentType res accept -> NH.Part -> BotServerRequest req contentType res accept
...
_setBodyBS :: BotServerRequest req contentType res accept -> B.ByteString -> BotServerRequest req contentType res accept
_setBodyBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: BotServerRequest req contentType res accept -> BL.ByteString -> BotServerRequest req contentType res accept
_setBodyLBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => BotServerRequest req contentType res accept -> P.Proxy authMethod -> BotServerRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    :: BotServerConfig
    -> a
    -> BotServerRequest req contentType res accept
    -> IO (BotServerRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> BotServerConfig
  -> IO (BotServerRequest req contentType res accept)
_applyAuthMethods req config@(BotServerConfig {configAuthMethods = as}) =
  foldlM go req as
  where
